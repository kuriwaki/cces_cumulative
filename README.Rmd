...
This repository is R code to build the Cooperative Congressional Election Study (CCES) cumulative file (2006 - 2024).



* [*Current Dataverse Version*](https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/II2DB6)
* [*Current Guide*](
https://github.com/kuriwaki/cces_cumulative/blob/main/guide/guide_cumulative_2006-2024.pdf)
...
# dat <- readRDS(here("data/release/cumulative_2006-2024.rds"))
dat <- arrow::read_feather(here::here("data/release/cumulative_2006-2024.feather"))
```
...
- `06_extract-politicians.R` pulls out the "contextual variables" at the respondent-level. information on candidates and representatives. It uses some long format voting tables from `05`.
- `07_merge-contextual_upload.R` combines all the variables together, essentially combining the output of `04` on `05`. Saves `.rds`, `.dta`, and `.feather` versions.
