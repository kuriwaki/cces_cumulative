...
This repository is R code to build the Cooperative Congressional Election Study (CCES) cumulative file (2006 - 2025).



* [*Current Dataverse Version*](https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/II2DB6)
* [*Current Guide*](
https://github.com/kuriwaki/cces_cumulative/blob/main/guide/guide_cumulative_2006-2025.pdf)
...
# dat <- readRDS(here("data/release/cumulative_2006-2025.rds"))
dat <- arrow::read_feather(here::here("data/release/cumulative_2006-2025.feather"))
```
