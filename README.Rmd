...
This repository is R code to build the Cooperative Congressional Election Study (CCES) cumulative file (2006 - 2017). 

2019-03-26 Note: I am actively finalizing the **2006 - 2018** cumulative dataset on this repo. Please contact me for any new additions you might want to see in this next release.

* [*Current Dataverse Version*](https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/II2DB6)
* [*Current Guide*]( 
https://github.com/kuriwaki/cces_cumulative/blob/master/guide/guide_cumulative_2006_2017.pdf)
