...
This repository is R code to build the Cooperative Congressional Election Study (CCES) cumulative file (2006 - 2020). 
...
df <- readRDS(find_rstudio_root_file("data/release/cumulative_2006-2020.Rds"))
```
