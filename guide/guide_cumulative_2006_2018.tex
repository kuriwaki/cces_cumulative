...
\date{Guide last updated: 2019-03-20}
...
# ... with 394,745 more rows, and 68 more variables: cong <int>,
...
# ... with 394,745 more rows, and 1 more variable: voted_sen_fec <chr>
\end{verbatim}
...
\begin{verbatim}
                 Min.               1st Qu.                Median 
"2006-10-07 00:02:34" "2010-10-06 17:21:07" "2012-10-10 11:58:30" 
                 Mean               3rd Qu.                  Max. 
"2012-09-17 22:09:37" "2015-11-11 02:25:15" "2018-11-05 22:18:53" 
\end{verbatim}
...
\begin{verbatim}
                          tookpost      n
 Did Not Take Post-Election Survey  51143
         Took Post-Election Survey 250813
                              <NA>  92799
\end{verbatim}
...
\begin{verbatim}
 ...
 0.0000  0.4076  0.7219  1.0000  1.1887 15.0006    2000 
\end{verbatim}
...
\begin{verbatim}
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max.    NA's 
 0.0000  0.2464  0.4803  0.8089  0.9657 19.3960    2000 
\end{verbatim}
...
\begin{verbatim}
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max.    NA's 
   0.00    0.43    0.71    1.00    1.13   15.00  296978 
\end{verbatim}
...
\begin{verbatim}
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max.    NA's 
  18.00   37.00   52.00   49.84   62.00  109.00    2000 
\end{verbatim}
...
\begin{verbatim}
                       pid7     n
            Strong Democrat 94021
   Not Very Strong Democrat 47849
              Lean Democrat 39451
                Independent 52706
            Lean Republican 42211
 Not Very Strong Republican 38070
          Strong Republican 66030
                   Not Sure 11491
                       <NA>  2926
\end{verbatim}
...
\begin{verbatim}
                     pid3_leaner      n
    Democrat (Including Leaners) 181321
  Republican (Including Leaners) 146311
 Independent (Excluding Leaners)  52706
                        Not Sure  11491
                            <NA>   2926
\end{verbatim}
...
\begin{verbatim}
                   economy_retro      n
              Gotten Much Better  18179
 Gotten Better / Somewhat Better  85983
           Stayed About The Same 101850
   Gotten Worse / Somewhat Worse 105662
               Gotten Much Worse  74666
                        Not Sure   7644
                            <NA>    771
\end{verbatim}
...
\begin{verbatim}
           newsint      n
  Most Of The Time 196583
  Some Of The Time  90164
 Only Now And Then  42629
     Hardly At All  20303
        Don't Know   8441
              <NA>  36635
\end{verbatim}
...
\begin{verbatim}
                  approval_pres      n
               Strongly Approve  78352
               Somewhat Approve  95536
            Somewhat Disapprove  41953
            Strongly Disapprove 166967
                       Not Sure  10800
...
\begin{verbatim}
                     approval_rep      n
                 Strongly Approve  57686
       Approve / Somewhat Approve 122975
 Disapprove / Somewhat Disapprove  68619
              Strongly Disapprove  61684
           Never Heard / Not Sure  75650
...
\begin{verbatim}
                    approval_sen1      n
                 Strongly Approve  51711
       Approve / Somewhat Approve 124869
 Disapprove / Somewhat Disapprove  78618
              Strongly Disapprove  76862
           Never Heard / Not Sure  56948
...
\begin{verbatim}
                    approval_sen2      n
                 Strongly Approve  54229
       Approve / Somewhat Approve 120459
 Disapprove / Somewhat Disapprove  77087
              Strongly Disapprove  77507
           Never Heard / Not Sure  59207
...
\begin{verbatim}
                   approval_gov      n
               Strongly Approve  57801
               Somewhat Approve 122423
            Somewhat Disapprove  74506
            Strongly Disapprove 102470
                       Not Sure  34168
...
\begin{verbatim}
           voted_pres_16      n
            Donald Trump  25199
          Hilary Clinton  30148
    Other / Someone Else   5630
            Did Not Vote    241
 Not Sure / Don't Recall    331
                    <NA> 333206
\end{verbatim}
...
\begin{verbatim}
                           intent_rep      n
             [Democrat / Candidate 1] 104693
           [Republican / Candidate 2]  97632
                [Other / Candidate 3]   4085
...
\begin{verbatim}
                     intent_sen      n
       [Democrat / Candidate 1]  78964
     [Republican / Candidate 2]  69174
          [Other / Candidate 3]   4131
...
\begin{verbatim}
                    intent_gov      n
      [Democrat / Candidate 1]  56231
    [Republican / Candidate 2]  50783
         [Other / Candidate 3]   3696
                         Other    900
                  I'm Not Sure  18532
                        No One   5793
...
\begin{verbatim}
                            voted_rep      n
             [Democrat / Candidate 1]  95401
           [Republican / Candidate 2]  94629
                [Other / Candidate 3]   2578
   $HouseCand4Name ($HouseCand4Party)     15
                                Other   2459
          I Did Not Vote In This Race  11630
   $HouseCand5Name ($HouseCand5Party)     22
                             Not Sure   4032
   $HouseCand6Name ($HouseCand6Party)     17
...
\begin{verbatim}
                      voted_sen      n
       [Democrat / Candidate 1]  69365
     [Republican / Candidate 2]  64243
          [Other / Candidate 3]   2755
                          Other   1638
                       Not Sure   1856
 $SenCand4Name ($SenCand4Party)     11
    I Did Not Vote In This Race   4133
                           <NA> 250754
\end{verbatim}
...
\begin{verbatim}
                   voted_gov      n
    [Democrat / Candidate 1]  47215
  [Republican / Candidate 2]  45662
       [Other / Candidate 3]   2478
                       Other   1181
 I Did Not Vote In This Race   4682
                    Not Sure    918
                        <NA> 292619
\end{verbatim}
