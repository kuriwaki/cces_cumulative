...
Agadjanian, Jeremiah Cha, Steve Ansolabehere, Stephen DiMauro, Bernard
Fraga, Nathan Kaplan, Silvia Kim, Mayya Komisarchik, Stephen Pettigrew,
Boris Shor, Brian Schaffner, and Gerlad Wright for finding errors and
providing suggestions. Thanks to Joe Williams at YouGov, and Jon Keane,
Mike Malecki, and Gordon Shotwell at Crunch for their help.}}


\date{Guide last updated: 2023-05-11}
...
\begin{quote}
Kuriwaki, Shiro, 2023, ``Cumulative CCES Common Content'',
\href{https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/II2DB6}{\url{doi:10.7910/DVN/II2DB6}},
Harvard Dataverse, V8.
\end{quote}

\medskip

This dataset combines 17 years (2006 -- 2022) of the Cooperative
...
principal investigators are Stephen Ansolabehere, Brian Schaffner, and
Marissa Shih.
...
\NormalTok{cc }\OtherTok{\textless{}{-}} \FunctionTok{read\_dta}\NormalTok{(}\StringTok{"cumulative\_2006{-}2022.dta"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{cc }\OtherTok{\textless{}{-}} \FunctionTok{get\_dataframe\_by\_name}\NormalTok{(}
  \AttributeTok{filename =} \StringTok{"cumulative\_2006{-}2022.dta"}\NormalTok{,}
...
\begin{verbatim}
 ...
 0.0000  0.4476  0.7331  1.0000  1.1609 15.0614 
\end{verbatim}
...
\begin{verbatim}
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
 0.0000  0.3013  0.5475  0.9031  1.0398 24.0297 
\end{verbatim}
...
\begin{verbatim}
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max.    NA's 
    0.0     0.4     0.7     1.0     1.1    15.5  365339 
\end{verbatim}
...
\begin{verbatim}
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max.    NA's 
    0.0     0.6     0.8     1.0     1.2    16.3  534371 
\end{verbatim}
...
\begin{verbatim}
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max.    NA's 
    0.0     0.5     0.8     1.0     1.2    15.0  541492 
\end{verbatim}
...
\hypertarget{gender-gender-binary}{%
\subsubsection{\texorpdfstring{\texttt{gender}: Gender
(binary)}{gender: Gender (binary)}}\label{gender-gender-binary}}
...
\item
  Years: All of 2006-2022
\item
  Although called \texttt{gender} for historically, this is a question
  asking people's sex. Until 2020, only two choices were allowed. From
  2021, the question was discontinued in favor of the question now
  called \texttt{gender4}. I have created a variable \texttt{sex} to
  more accurately capture what the \texttt{gender} question has asked
  2006--2020.
\item
  This \texttt{gender} maintains a binary variable for all years by
  making the following custom recodes for 2021 onwards: \texttt{Man} in
  \texttt{gender4} is recoded to \texttt{Male}, \texttt{Woman} in
  \texttt{gender4} is recoded to \texttt{Female}, and other categories
  are coded as missing.
\end{itemize}

\hypertarget{gender4-gender}{%
...
\begin{verbatim}
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max.    NA's 
    1.0     1.0     2.0     1.6     2.0     4.0  531755 
\end{verbatim}
...
\begin{verbatim}
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max.    NA's 
   1.00    1.00    2.00    1.54    2.00    2.00   85700 
\end{verbatim}
...
\begin{verbatim}
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
  18.00   35.00   51.00   49.57   63.00  109.00 
\end{verbatim}
...
\midrule
No HS & 20,532\\
High School Graduate & 170,160\\
Some College & 148,868\\
2-Year & 61,829\\
4-Year & 140,123\\
Post-Grad & 75,876\\
(Missing) & 67\\
...
Hispanic & 51,773\\
Asian & 13,813\\
Native American & 5,045\\
Mixed & 13,013\\
Other & 10,424\\
Middle Eastern & 1,011\\
\bottomrule
\end{tabular}
\end{table}
...
\hypertarget{race_h-race-any-part-hispanic}{%
...
``What racial or ethnic group best describes you? - combined with
hispanic ethnicity''
...
\hypertarget{hisp_origin-hispanic-origin}{%
...
South America & 3,290\\
Cuba & 2,411\\
Central America & 2,075\\
Dominican Republic & 1,191\\
Caribbean & 590\\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
Protestant & 214,761\\
Roman Catholic & 117,846\\
Mormon & 8,451\\
Eastern or Greek Orthodox & 3,061\\
Jewish & 14,573\\
Muslim & 3,202\\
Buddhist & 4,972\\
Hindu & 1,710\\
Atheist & 31,267\\
Agnostic & 34,344\\
Nothing in Particular & 107,080\\
Something Else & 38,679\\
(Missing) & 37,509\\
\bottomrule
\end{tabular}
\end{table}
...
\toprule
 & n\\
\midrule
Very Important & 219,969\\
Somewhat Important & 146,073\\
Not Too Important & 83,451\\
Not at All Important & 114,724\\
(Missing) & 53,238\\
\bottomrule
\end{tabular}
\end{table}
...
\tightlist
\item
  Years: All of 2008-2022
\item
  In common content, often named \texttt{pew\_religimp}
\end{itemize}

\hypertarget{relig_bornagain-evangelical-christian}{%
...
\tightlist
\item
  Years: All of 2006-2022 except 2007
\item
  In common content, often named \texttt{pew\_bornagain}
\end{itemize}

\hypertarget{relig_protestant-branch-of-protestantism}{%
...
Baptist & 67,029\\
Methodist & 30,279\\
Nondenominational or Independent Church & 46,555\\
Lutheran & 23,413\\
Presbyterian & 14,661\\
Pentecostal & 14,317\\
Episcopalian & 10,301\\
Church of Christ or Disciples of Christ & 8,354\\
Congregational or United Church of Christ & 5,252\\
Holiness & 2,075\\
Reformed & 1,953\\
Adventist & 2,153\\
Jehovah's Witness & 2,454\\
Something Else & 15,431\\
(Missing) & 373,228\\
\bottomrule
\end{tabular}
\end{table}
...
\hypertarget{relig_church-church-attendance}{%
...
\toprule
 & n\\
\midrule
More Than Once a Week & 48,485\\
Once a Week & 102,164\\
Once or Twice a Month & 44,893\\
A Few Times a Year & 79,465\\
Seldom & 131,330\\
Never & 155,949\\
Don't Know & 8,010\\
(Missing) & 47,159\\
...
Divorced & 67,939\\
Widowed & 30,203\\
Single / Never Married & 148,819\\
Domestic Partnership & 30,405\\
(Missing) & 1,615\\
\bottomrule
\end{tabular}
\end{table}
...
I Plan to Vote Before November 8th & 1,668\\
No & 27,341\\
Undecided & 19,922\\
(Missing) & 262,293\\
\bottomrule
...
\toprule
 & n\\
\midrule
Strong Democrat & 151,451\\
Not Very Strong Democrat & 73,609\\
Lean Democrat & 62,225\\
Independent & 85,769\\
Lean Republican & 61,635\\
Not Very Strong Republican & 57,712\\
Strong Republican & 103,321\\
Not Sure & 18,698\\
Don't Know & 3\\
(Missing) & 3,032\\
\bottomrule
...
\toprule
 & n\\
\midrule
Democrat (Including Leaners) & 287,285\\
Republican (Including Leaners) & 222,668\\
Independent (Excluding Leaners) & 85,769\\
Not Sure & 18,698\\
(Missing) & 3,035\\
\bottomrule
\end{tabular}
...
Liberal & 109,815\\
Moderate & 193,203\\
Conservative & 134,854\\
Very Conservative & 71,066\\
Not Sure & 44,419\\
(Missing) & 1,879\\
\bottomrule
\end{tabular}
...
Full-Time & 242,346\\
Part-Time & 63,873\\
Temporarily Laid Off & 5,274\\
Unemployed & 40,686\\
Retired & 133,488\\
Permanently Disabled & 36,906\\
Homemaker & 43,484\\
Student & 26,618\\
Other & 14,440\\
(Missing) & 10,340\\
...
\toprule
 & n\\
\midrule
Gotten much better & 40,500\\
Gotten better / somewhat better & 123,134\\
Stayed about the same & 142,781\\
Gotten worse / somewhat worse & 156,418\\
Gotten much worse & 137,222\\
Not sure & 16,285\\
(Missing) & 1,115\\
\bottomrule
\end{tabular}
...
\toprule
 & n\\
\midrule
Most of the time & 307,945\\
Some of the time & 148,566\\
Only now and then & 71,236\\
Hardly at all & 36,819\\
Don't Know & 15,751\\
(Missing) & 37,138\\
\bottomrule
\end{tabular}
...
\toprule
 & n\\
\midrule
Strongly Approve & 128,999\\
Approve / Somewhat Approve & 140,341\\
Disapprove / Somewhat Disapprove & 62,062\\
Strongly Disapprove & 267,393\\
Never Heard / Not Sure & 17,343\\
...
\toprule
 & n\\
\midrule
Strongly Approve & 91,891\\
Approve / Somewhat Approve & 180,929\\
Disapprove / Somewhat Disapprove & 98,594\\
Strongly Disapprove & 103,183\\
Never Heard / Not Sure & 106,598\\
...
\toprule
 & n\\
\midrule
Strongly Approve & 83,765\\
Approve / Somewhat Approve & 182,263\\
Disapprove / Somewhat Disapprove & 113,642\\
Strongly Disapprove & 132,246\\
Never Heard / Not Sure & 81,791\\
...
\toprule
 & n\\
\midrule
Strongly Approve & 91,859\\
Approve / Somewhat Approve & 174,872\\
Disapprove / Somewhat Disapprove & 107,611\\
Strongly Disapprove & 134,491\\
Never Heard / Not Sure & 83,387\\
...
\toprule
 & n\\
\midrule
Strongly Approve & 102,803\\
Approve / Somewhat Approve & 188,361\\
Disapprove / Somewhat Disapprove & 108,049\\
Strongly Disapprove & 161,245\\
Never Heard / Not Sure & 52,785\\
...
Joe Biden & 67,415\\
Donald Trump & 46,128\\
Other / Someone Else & 3,980\\
Did not Vote for President & 12,737\\
Not Sure & 190\\
Other & 113\\
(Missing) & 486,892\\
\bottomrule
...
{}{[Republican / Candidate 2]} & 148,870\\
{}{[Other / Candidate 3]} & 5,034\\
...
{}{[Republican / Candidate 2]} & 104,431\\
{}{[Other / Candidate 3]} & 4,701\\
...
{}{[Republican / Candidate 2]} & 83,393\\
{}{[Other / Candidate 3]} & 4,218\\
Other & 1,929\\
Not Sure & 29,620\\
No One & 10,968\\
...
{}{[Republican / Candidate 2]} & 144,795\\
{}{[Other / Candidate 3]} & 3,163\\
...
{}{[Republican / Candidate 2]} & 98,985\\
{}{[Other / Candidate 3]} & 3,232\\
...
{}{[Republican / Candidate 2]} & 74,674\\
{}{[Other / Candidate 3]} & 2,724\\
...
\hypertarget{version-8.0}{%
\subsubsection{Version 8.0}\label{version-8.0}}

\begin{itemize}
\tightlist
\item
  Released \texttt{2023-05-01}
\item
  Added \texttt{gender4} (a variable for gender identification
  introduced in 2021), add back \texttt{gender} for 2021-2022, and add
  \texttt{sex} for 2006-2020.
\item
  Adds a ``any-part Hispanic'' variable, \texttt{race\_h}, that combines
  \texttt{race} and \texttt{hispanic}.
\item
  Adds a ``Hispanic origin'' variable, \texttt{hisp\_origin}, which
  concatenates the responses to the hispanic question.
\item
  Added more religion variables (\texttt{relig\_imp},
