...
\date{Guide last updated: 2020-03-15}
...
\hypertarget{intent_pres_party-president-preference-part}{%
\subsubsection{\texorpdfstring{\texttt{intent\_pres\_party}: President
preference
part}{intent\_pres\_party: President preference part}}\label{intent_pres_party-president-preference-part}}
...
\item
  ...
  2018, 2019
\item
  Note: In a presidential election year, this asks the vote of that
  year. The vote choice of the presidential election 4 years prior is
  often recorded in the individual common content but not in this
  cumulative file.
\end{itemize}
