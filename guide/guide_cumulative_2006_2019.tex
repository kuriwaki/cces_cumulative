...
\date{Guide last updated: 2020-04-14}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cc <{-}}\StringTok{ }\KeywordTok{readRDS}\NormalTok{(}\StringTok{"cumulative\_2006\_2019.Rds"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cc16 <{-}}\StringTok{ }\KeywordTok{read\_dta}\NormalTok{(}\StringTok{"CCES16\_Common\_OUTPUT\_Feb2018\_VV.dta"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{\# subset}
\NormalTok{cc16\_rc <{-}}\StringTok{ }\KeywordTok{select}\NormalTok{(cc16, V101, }\KeywordTok{matches}\NormalTok{(}\StringTok{"CC16\_351"}\NormalTok{))}

\CommentTok{\# join on case ID}
\NormalTok{cc\_rc <{-}}\StringTok{ }\NormalTok{cc }\OperatorTok{\%>\%}\StringTok{ }
...
\tightlist
\item
  Released \texttt{2020-04-15}
\item
  Enter 2019 common content (up to n = 470,755)
\item
  Adds variables for: employment, union membership, religion,
