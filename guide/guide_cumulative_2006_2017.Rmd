...
output:
  pdf_document:
    ...
    keep_tex: TRUE
title: "CCES Cumulative Common Content (2006 - 2017)"
...
df <- readRDS(find_rstudio_root_file("data/release/cumulative_2006_2017.Rds"))
...
\noindent This dataset combines twelve years (2006 - 2017) of the Cooperative Congressional Election Study (Principal Investigators: Stephen Ansolabehere, Sam Luks, Brian Schaffner).
...
A Stata dta file is provided as well. `cumulative_2006_2017.dta` can be read by Stata, or in R by the `haven` package 

```{r, eval = FALSE, echo = TRUE}
library(haven)
df <- read_dta("cumulative_2006_2017.dta")
```
