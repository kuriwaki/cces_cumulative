...
thanks: "Department of Government, Harvard University. Website: \\url{https://www.shirokuriwaki.com}. ORCID: \\url{https://orcid.org/0000-0002-5687-2647}. Bug reports welcome.  My thanks to Alexander Agadjanian, Steve Ansolabehere, Stephen DiMauro, Bernard Fraga, Nathan Kaplan, Mayya Komisarchik, Stephen Pettigrew, and Boris Shor for their suggestions and contributions. Thanks to Joe Williams at YouGov, and Jon Keane,  Mike Malecki, and Gordon Shotwell at Crunch for their help."
...
cc <- readRDS(find_rstudio_root_file("data/release/cumulative_2006-2019.Rds"))
...
> Kuriwaki, Shiro, 2020, "Cumulative CCES Common Content (2006-2019)", \href{https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/II2DB6}{\url{doi:10.7910/DVN/II2DB6}}, Harvard Dataverse, V5. 
...
cc <- readRDS("cumulative_2006-2019.Rds")
```
...
```{r, eval = FALSE, echo = TRUE}
library(haven)
cc <- read_dta("cumulative_2006-2019.dta")
```
