...
\date{Guide last updated: 2021-04-05}
...
formats such as plain-text, or SPSS sav files. Plain-text formats are
...
without dowloading the file to one's computer. The recent version of
\texttt{dataverse} (\textgreater{} 0.3.0) allows this by the function:
...
\toprule
 & n\\
\midrule
Did Not Take Post-Election Survey & 138,064\\
...
\tightlist
\item
  Years: 2006, 2008, 2010, 2012, 2014, 2016, 2018, 2019, 2020
...
\item
  Added usage example of the R \texttt{dataverse} pacakge
\end{itemize}
