...
cc <- get_dataframe_by_name(
  filename = "cumulative_2006-2019.dta",
...
`r descrip(turnout_self)`

```{r, results = "asis"}
print_tab(turnout_self)
```

* Years: `r in_years(turnout_self)`
...
- Added further explanation to usage of weighs where post-election weights are not available (thanks to Alexander Agadjanian)
