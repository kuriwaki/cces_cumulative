...
thanks: "Department of Political Science, Yale University. Website: \\url{https://www.shirokuriwaki.com}. ORCID: \\url{https://orcid.org/0000-0002-5687-2647}. My thanks to Alexander Agadjanian, Jeremiah Cha, Steve Ansolabehere, Valerie Bradley, Stephen DiMauro, Bernard Fraga, Nathan Kaplan, Silvia Kim, Mayya Komisarchik, Stephen Pettigrew, Boris Shor, Brian Schaffner, and Gerlad Wright for finding errors and providing suggestions. Thanks to Joe Williams at YouGov, and Jon Keane,  Mike Malecki, and Gordon Shotwell at Crunch for their help."
...
cc <- arrow::read_feather(find_rstudio_root_file("data/release/cumulative_2006-2023.feather"))
...
in_years <- function(var, tbl = cc) {
  ...
  if (identical(yrs_vec, 2006:2023)) return("All of 2006-2023")  
  if (identical(yrs_vec, 2008:2023)) return("All of 2008-2023")  
  if (identical(yrs_vec, setdiff(c(2006:2023), 2007))) return("All of 2006-2023 except 2007")  
...
> Kuriwaki, Shiro, 2024, "Cumulative CES Common Content", \href{https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/II2DB6}{\url{doi:10.7910/DVN/II2DB6}}, Harvard Dataverse, V9. 
...
cc <- readRDS("cumulative_2006-2023.rds")
```
...
Version 8.0 includes an experimental `.feather` format. This is a format compatible in both R and Python, and reads and writes faster. For example, in R, use the function `read_feather` from the `arrow` package. However, reading the Stata file in Python via pandas may retain more of the variable labels than the python file.
...
* Years: `r in_years(vv_turnout_gvm)` (2022 validated vote to be released in Version 9).
...
### Version 9.0 (released `XXXX-XX-XX`)
