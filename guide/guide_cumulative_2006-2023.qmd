...
in_years <- function(var, tbl = cc) {
  ...
  if (identical(yrs_vec, 2007:2023)) return("All of 2007-2023")  
  ...
  if (identical(yrs_vec, 2009:2023)) return("All of 2009-2023")  
...
This dataset combines `r english::english(2023 - 2006 + 1)` years (2006 -- 2023) of the Cooperative Congressional Election Study (CCES), renamed the Cooperative Congressional Election Study (CES) from 2020. The CCES/CES is an online survey conducted around November of each year, asking a range of questions on political behavior and public opinion. Its current principal investigators are Stephen Ansolabehere, Jeremy Pope, Brian Schaffner, and Marissa Shih.
