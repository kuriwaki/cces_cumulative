...
- Includes vote validation for 2024. Value label numbering has changed as a result.
- Adds vote validated registered state as variable (`vv_state`)
- Renames what was previously `rvweight` as `vvweight` so that it is consistent with the Common content
