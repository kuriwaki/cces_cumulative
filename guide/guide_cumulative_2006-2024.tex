...
\item
  ...
  match as of V11 of this dataverse replication, for example, TS did not
  report NPAs as a separate category in Florida. {[}From 2018: Note that
  if the state's voter roll does not record party registration, this
  value will be missing.{]} Not available for some old even years.
\end{itemize}
...
\texttt{2025-10-05})}{Version 11.0 (released 2025-10-05)}}\label{version-11.0-released-2025-10-05}
...
\item
  Adds vote validated registered state as variable (\texttt{v\_state})
\item
  Standardize ``Never Heard of this Person'' in 2013-2014, 2018 to
  ``Never Heard'' like other years
