...
Jo Jorgensen & 2,182\\
Howie Hawkins & 783\\
Did not Vote for President & 31,056\\
Other & 3,371\\
(Missing) & 486,948\\
\bottomrule
\end{tabular}
...
$ voted_pres_party  <fct> NA, NA, NA, NA, NA, Did not Vote, NA, NA, NA, Did no~
...
\subsubsection{Version 10.0 (released)}\label{version-10.0-released}
...
\item
  ...
  post-election wave in that year. Add ``Did not vote'' (turnout) and
  undervoting in Presidential vote
\item
