...
\NormalTok{cc }\OtherTok{\textless{}{-}} \FunctionTok{get\_dataframe\_by\_name}\NormalTok{(}
  ...
  \AttributeTok{version =} \StringTok{"11"}\NormalTok{,}
  \AttributeTok{dataset =} \StringTok{"10.7910/DVN/II2DB6"}\NormalTok{,}
  \AttributeTok{original =} \ConstantTok{TRUE}\NormalTok{,}
...
\item
  ...
  of the 2014 CCES cumulative file, which was updated in 2024 to fix
  some congressional district variables. This changes 41 rows
  (\textless{} 1 \% of 2014 data) in the following variables:
  \texttt{tookpost}, \texttt{state\_post}, \texttt{st\_post},
  \texttt{dist\_post}, \texttt{dist\_up\_post}, \texttt{cd\_post},
  \texttt{cd\_up\_post}, \texttt{voted\_turnout\_self},
  \texttt{voted\_pres\_party}, \texttt{voted\_rep},
  \texttt{voted\_rep\_chosen}, \texttt{voted\_rep\_party},
  \texttt{voted\_sen}, \texttt{voted\_sen\_chosen},
  \texttt{voted\_sen\_party}, \texttt{voted\_gov},
  \texttt{voted\_gov\_chosen}, and \texttt{voted\_gov\_party}
\item
