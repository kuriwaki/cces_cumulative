...
\begin{quote}
Kuriwaki, Shiro, 2026, ``Cumulative CES Common Content'',
...
This dataset combines 20 years (2006 -- 2025) of the Cooperative
...
principal investigators are Brian Schaffner, Jeremy Pope, and Marissa
Shih.

\medskip

Each year's CCES/CES asks hundreds of questions, many of which change
from year to year. This cumulative file only includes a subset of those
questions that are standard and important. It standardizes its values
across years and creates a few new variables too. Users can still merge
in their year-specific questions of interest easily into this cumulative
file and take advantage of its standardized variables.

\medskip

I constructed this dataset from each year's full CCES/CES, all of them
publicly available as separate datasets on
\href{https://dataverse.harvard.edu/dataverse/cces}{Dataverse}.The final
product is a \texttt{tibble}-style data frame built in R that is also
available as a Stata \texttt{dta} file and a \texttt{feather} file.
...
\NormalTok{cc }\OtherTok{\textless{}{-}} \FunctionTok{read\_dta}\NormalTok{(}\StringTok{"cumulative\_2006{-}2025.dta"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cc }\OtherTok{\textless{}{-}} \FunctionTok{read\_rds}\NormalTok{(}\StringTok{"cumulative\_2006{-}2025.rds"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{cc }\OtherTok{\textless{}{-}} \FunctionTok{read\_feather}\NormalTok{(}\StringTok{"cumulative\_2006{-}2025.feather"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{cc }\OtherTok{\textless{}{-}} \FunctionTok{get\_dataframe\_by\_name}\NormalTok{(}
  \AttributeTok{filename =} \StringTok{"cumulative\_2006{-}2025.dta"}\NormalTok{,}
...
argument with \texttt{cumulative\_2006-2025.feather} and the \texttt{.f}
...
\FunctionTok{library}\NormalTok{(dataverse)}
\NormalTok{cc }\OtherTok{\textless{}{-}} \FunctionTok{get\_dataframe\_by\_name}\NormalTok{(}
  \AttributeTok{filename =} \StringTok{"cumulative\_2006{-}2025.feather"}\NormalTok{,}
  \AttributeTok{version =} \StringTok{"12"}\NormalTok{,}
  \AttributeTok{dataset =} \StringTok{"10.7910/DVN/II2DB6"}\NormalTok{,}
  \AttributeTok{original =} \ConstantTok{TRUE}\NormalTok{,}
...
\toprule
 & n\\
\midrule
Did Not Take Post-Election Survey & 88,135\\
Took Post-Election Survey & 452,821\\
(Missing) & 177,999\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{verbatim}
 ...
 0.0000  0.4337  0.7310  1.0000  1.1644 15.0614 
\end{verbatim}
...
\begin{verbatim}
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
 0.0000  0.2662  0.4918  0.8137  0.9494 24.3029 
\end{verbatim}
...
\begin{verbatim}
   ...
   0.00    0.45    0.69    1.00    1.07   15.50  466839 
\end{verbatim}
...
\begin{verbatim}
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max.    NA's 
   0.00    0.53    0.79    1.00    1.16   16.31  554396 
\end{verbatim}
...
\begin{verbatim}
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max.    NA's 
   0.00    0.50    0.75    1.00    1.14   15.18  568380 
\end{verbatim}
...
\toprule
 & n\\
\midrule
Heterosexual / Straight & 346,676\\
Lesbian / Gay Woman & 5,641\\
Gay Man & 11,507\\
Bisexual & 19,187\\
Other & 5,545\\
Prefer not to Say & 9,203\\
(Missing) & 321,196\\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
No HS & 24,510\\
High School Graduate & 198,203\\
Some College & 171,557\\
2-Year & 72,815\\
4-Year & 162,609\\
Post-Grad & 89,194\\
(Missing) & 67\\
...
Hispanic & 62,677\\
Asian & 18,091\\
Native American & 5,960\\
Mixed & 15,823\\
Other & 11,949\\
Middle Eastern & 1,287\\
\bottomrule
\end{tabular}
\end{table}
...
Hispanic & 83,212\\
Asian & 17,641\\
Native American & 5,378\\
Mixed & 11,075\\
Other & 10,881\\
Middle Eastern & 1,219\\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
Mexico & 22,179\\
United States & 21,296\\
Spain & 9,767\\
Puerto Rico & 8,589\\
South America & 4,378\\
Cuba & 3,238\\
Central America & 2,806\\
...
\midrule
Protestant & 246,102\\
Roman Catholic & 137,629\\
Mormon & 9,493\\
Eastern or Greek Orthodox & 3,672\\
Jewish & 17,018\\
Muslim & 4,156\\
Buddhist & 5,938\\
Hindu & 2,112\\
Atheist & 38,351\\
Agnostic & 41,167\\
Nothing in Particular & 128,941\\
Something Else & 46,766\\
(Missing) & 37,610\\
\bottomrule
\end{tabular}
\end{table}
...
\toprule
 & n\\
\midrule
Very Important & 255,435\\
Somewhat Important & 171,379\\
Not Too Important & 99,199\\
Not at All Important & 139,671\\
(Missing) & 53,271\\
\bottomrule
\end{tabular}
\end{table}
...
\tightlist
\item
  Years: All of 2006-2025 except 2007
\item
...
Baptist & 78,254\\
Methodist & 34,321\\
Nondenominational or Independent Church & 55,431\\
Lutheran & 26,734\\
Presbyterian & 16,669\\
Pentecostal & 17,043\\
Episcopalian & 11,638\\
Church of Christ or Disciples of Christ & 9,985\\
Congregational or United Church of Christ & 5,992\\
Holiness & 2,494\\
Reformed & 2,263\\
Adventist & 2,496\\
Jehovah's Witness & 2,959\\
Something Else & 22,444\\
(Missing) & 430,232\\
\bottomrule
\end{tabular}
\end{table}
...
\toprule
 & n\\
\midrule
More Than Once a Week & 55,428\\
Once a Week & 118,281\\
Once or Twice a Month & 51,561\\
A Few Times a Year & 92,132\\
Seldom & 153,673\\
Never & 190,731\\
Don't Know & 9,948\\
8 & 28\\
...
Divorced & 80,205\\
Widowed & 36,593\\
Single / Never Married & 178,683\\
Domestic Partnership & 36,245\\
(Missing) & 1,646\\
\bottomrule
\end{tabular}
\end{table}
...
\toprule
 & n\\
\midrule
No Record of Party Registration & 185,752\\
Unknown & 87,810\\
Democratic Party & 74,083\\
Republican Party & 53,494\\
No Party Affiliation & 18,380\\
Declined to State & 3,093\\
Independent Party & 2,829\\
Other & 2,783\\
No Party, Independent, Declined to State & 2,737\\
...
I plan to vote before Election Day & 10,809\\
No & 30,905\\
Undecided & 22,407\\
(Missing) & 303,793\\
\bottomrule
...
\item
  ...
  Some response categories are still not standardized. For example, ``I
  plan to vote before Election Day'' is unavailable in 2016.
  Additionally, the question is available in years 2010 and earlier but
  not included in this version of the cumulative dataset because those
  years rely on a 2006--2012 cumulative release.
\end{itemize}
...
\toprule
 & n\\
\midrule
Strong Democrat & 177,639\\
Not Very Strong Democrat & 84,868\\
Lean Democrat & 72,445\\
Independent & 100,803\\
Lean Republican & 70,497\\
Not Very Strong Republican & 66,693\\
Strong Republican & 121,581\\
Not Sure & 21,394\\
Don't Know & 3\\
(Missing) & 3,032\\
\bottomrule
...
\toprule
 & n\\
\midrule
Democrat (Including Leaners) & 334,952\\
Republican (Including Leaners) & 258,771\\
Independent (Excluding Leaners) & 100,803\\
Not Sure & 21,394\\
(Missing) & 3,035\\
\bottomrule
\end{tabular}
...
Liberal & 127,826\\
Moderate & 226,665\\
Conservative & 154,203\\
Very Conservative & 82,120\\
Not Sure & 51,698\\
(Missing) & 1,902\\
\bottomrule
\end{tabular}
...
Full-Time & 278,711\\
Part-Time & 75,424\\
Temporarily Laid Off & 6,046\\
Unemployed & 48,341\\
Retired & 159,521\\
Permanently Disabled & 43,739\\
Homemaker & 49,286\\
Student & 30,556\\
Other & 16,763\\
(Missing) & 10,568\\
...
\toprule
 & n\\
\midrule
Yes, Currently & 48,930\\
Yes, Formerly & 128,804\\
No, Never & 505,197\\
(Missing) & 36,024\\
\bottomrule
\end{tabular}
...
\toprule
 & n\\
\midrule
Gotten much better & 48,690\\
Gotten better / somewhat better & 142,663\\
Stayed about the same & 157,934\\
Gotten worse / somewhat worse & 179,494\\
Gotten much worse & 169,714\\
Not sure & 19,232\\
(Missing) & 1,228\\
\bottomrule
\end{tabular}
...
\toprule
 & n\\
\midrule
Most of the time & 356,238\\
Some of the time & 177,088\\
Only now and then & 84,910\\
Hardly at all & 45,032\\
Don't Know & 18,497\\
(Missing) & 37,190\\
\bottomrule
\end{tabular}
...
\toprule
 & n\\
\midrule
Strongly Approve & 148,046\\
Approve / Somewhat Approve & 164,754\\
Disapprove / Somewhat Disapprove & 73,716\\
Strongly Disapprove & 310,395\\
Never Heard / Not Sure & 20,723\\
...
\toprule
 & n\\
\midrule
Strongly Approve & 107,889\\
Approve / Somewhat Approve & 203,678\\
Disapprove / Somewhat Disapprove & 109,700\\
Strongly Disapprove & 122,353\\
Never Heard / Not Sure & 164,311\\
...
\toprule
 & n\\
\midrule
Strongly Approve & 100,198\\
Approve / Somewhat Approve & 204,378\\
Disapprove / Somewhat Disapprove & 126,694\\
Strongly Disapprove & 157,591\\
Never Heard / Not Sure & 123,274\\
...
\toprule
 & n\\
\midrule
Strongly Approve & 109,341\\
Approve / Somewhat Approve & 195,444\\
Disapprove / Somewhat Disapprove & 118,168\\
Strongly Disapprove & 160,161\\
Never Heard / Not Sure & 128,510\\
...
\toprule
 & n\\
\midrule
Strongly Approve & 124,382\\
Approve / Somewhat Approve & 217,257\\
Disapprove / Somewhat Disapprove & 123,254\\
Strongly Disapprove & 187,857\\
Never Heard / Not Sure & 61,714\\
...
\toprule
 & n\\
\midrule
Kamala Harris & 29,766\\
Donald Trump & 24,108\\
Jill Stein & 480\\
Robert F. Kennedy, Jr. & 277\\
Cornel West & 129\\
Chase Oliver & 332\\
Other & 705\\
Undervote & 4,916\\
...
{}{[Other / Candidate 4]} & 126\\
Other & 3,568\\
{}{[Other / Candidate 5]} & 40\\
I Won't Vote in this Election & 2,269\\
{}{[Other / Candidate 6]} & 74\\
{}{[Other / Candidate 9]} & 2\\
{}{[Other / Candidate 7]} & 37\\
{}{[Other / Candidate 8]} & 24\\
{}{[Other / Candidate 10]} & 1\\
{}{[Other / Candidate 11]} & 3\\
No One & 30,443\\
Not Sure & 97,076\\
(Missing) & 223,430\\
\bottomrule
...
\toprule
 & n\\
\midrule
{}{[Democrat / Candidate 1]} & 186,065\\
{}{[Republican / Candidate 2]} & 162,980\\
{}{[Other / Candidate 3]} & 3,502\\
{}{[Other / Candidate 4]} & 91\\
{}{[Other / Candidate 7]} & 37\\
Other & 4,773\\
I Did Not Vote In This Race & 12,362\\
{}{[Other / Candidate 5]} & 42\\
Not Sure & 6,394\\
{}{[Other / Candidate 6]} & 66\\
I Did not Vote in this Race & 3,651\\
I Did not Vote & 345\\
{}{[Other / Candidate 8]} & 16\\
{}{[Other / Candidate 9]} & 2\\
...
\toprule
 & n\\
\midrule
{}{[Democrat / Candidate 1]} & 134,774\\
{}{[Republican / Candidate 2]} & 112,422\\
{}{[Other / Candidate 3]} & 3,361\\
{}{[Other / Candidate 4]} & 64\\
Other & 2,316\\
I Did not Vote & 28\\
Not Sure & 2,733\\
...
\toprule
 & n\\
\midrule
{}{[Democrat / Candidate 1]} & 90,215\\
{}{[Republican / Candidate 2]} & 79,031\\
{}{[Other / Candidate 3]} & 2,893\\
{}{[Other / Candidate 4]} & 8\\
{}{[Other / Candidate 5]} & 10\\
I Did not Vote in this Race & 327\\
I Did not Vote & 62\\
Other & 2,479\\
I Did Not Vote In This Race & 4,328\\
Not Sure & 1,344\\
(Missing) & 538,258\\
\bottomrule
\end{tabular}
...
\tightlist
\item
  Years: 2006, 2008, 2010, 2012, 2013, 2014, 2015, 2016, 2017, 2018,
  2019, 2020, 2021, 2022, 2023, 2024, 2025. Odd-year Governor elections
  in NJ, VA, KY, MS, and LA start to appear in 2013.
\item
...
$ case_id <dbl> 439219, 439224, 439228, 439237, 439238, 439242, 439251, 439254~
\end{verbatim}
...
\subsubsection{\texorpdfstring{Version 12.0 (released
\texttt{2026-})}{Version 12.0 (released 2026-)}}\label{version-12.0-released-2026-}

\begin{itemize}
\tightlist
\item
  Adds 2025 common content
\item
  Adds odd-year governor vote choice for the states that have them (NJ,
  VA, KY, MS, LA), starting in 2013. (\#61)
\item
  Adds 2008 values for individual union membership (\#73, Brian
  Schaffner)
\item
  For 2014 data, now uses an updated
  \href{https://dataverse.harvard.edu/file.xhtml?fileId=10703502&version=6.0}{V6}
  of the 2014 CCES file, which was updated in 2024 to fix some CD
  variables. This changes 41 rows (\textless{} 1 \% of 2014 data) in the
  following variables: \texttt{tookpost}, \texttt{state\_post},
  \texttt{st\_post},
  \texttt{(dist\textbar{}cd\textbar{}dist\_up\textbar{}cd\_post)\_post},
  \texttt{voted\_turnout\_self}, and
  \texttt{voted\_(pres\textbar{}rep\textbar{}sen\textbar{}gov)\_(party\textbar{}chosen\textbar{})}.
\item
  ...
  of the 2022 CCES file, which was updated in April 2024 to fill missing
  county FIPS codes. This adds \texttt{county\_fips} for 131 rows
  (\textless{} 1 \% of 2022 data).
\item
  Standardizes the early-vote label in \texttt{intent\_turnout\_self}
  (\#79)
\item
  Fixes candidate-slot matching for down-ballot vote-choice variables
  when raw CCES labels refer to Candidate 4 or higher. Among non-missing
  values, this changes less than 0.1\% of rows in
  \texttt{(intent\textbar{}vote)\_rep(\textbar{}chosen\textbar{}party)}
  variables, less than 0.05\% of rows in
  \texttt{(intent\textbar{}vote)\_sen(\textbar{}chosen\textbar{}party)}
  and 0.01\% of rows in \texttt{voted\_gov} (\#70)
\item
...
\item
  Media, Knowledge, and attention variables are starting to built off in
  a new repo, https://github.com/kuriwaki/cces\_cumulative\_knowledge. 7
\end{itemize}
...
\tightlist
\item
  Includes vote validation variables for 2024 (\texttt{vv\_regstatus},
  \texttt{vv\_turnout\_gvm}, etc..). Value label numbering has changed
  as a result.
\item
  Adds vote validated registered state as variable (\texttt{vv\_state})
\item
  Renames what was previously \texttt{rvweight} to \texttt{vvweight} so
