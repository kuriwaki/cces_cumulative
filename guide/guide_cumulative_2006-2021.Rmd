...
thanks: "Department of Political Science, Yale University. Website: \\url{https://www.shirokuriwaki.com}. ORCID: \\url{https://orcid.org/0000-0002-5687-2647}. My thanks to Alexander Agadjanian, Jeremiah Cha, Steve Ansolabehere, Stephen DiMauro, Bernard Fraga, Nathan Kaplan, Silvia Kim, Mayya Komisarchik, Stephen Pettigrew, Boris Shor, Brian Schaffner, and Gerlad Wright for their suggestions and contributions. Thanks to Joe Williams at YouGov, and Jon Keane,  Mike Malecki, and Gordon Shotwell at Crunch for their help."
...
cc <- readRDS(find_rstudio_root_file("data/release/cumulative_2006-2021.rds"))
...
in_years <- function(var, tbl = cc) {
  ...
  if (identical(yrs_vec, 2007:2021)) return("All of 2007-2021")  
  if (identical(yrs_vec, 2008:2021)) return("All of 2008-2021")  
  if (identical(yrs_vec, setdiff(c(2006:2021), 2007))) return("All of 2006-2021 except 2007")  
