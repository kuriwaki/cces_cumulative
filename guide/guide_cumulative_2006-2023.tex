...
This dataset combines 18 years (2006 -- 2023) of the Cooperative
...
principal investigators are Stephen Ansolabehere, Jeremy Pope, Brian
Schaffner, and Marissa Shih.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cc }\OtherTok{\textless{}{-}} \FunctionTok{read\_rds}\NormalTok{(}\StringTok{"cumulative\_2006{-}2023.rds"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{cc }\OtherTok{\textless{}{-}} \FunctionTok{read\_feather}\NormalTok{(}\StringTok{"cumulative\_2006{-}2023.feather"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
