...
1. Obtain Access: For View access to the dataset (free), please [sign up here](https://tufts.qualtrics.com/jfe/form/SV_1A0vMbbE6j0fubr) or via the CCES website. For questions and more access, please contact the CCES Team.
...
- Adds variables for: employment, union membership, religion, citizenship, children, homeownership, lack of insurance, and lack of military members in immediate family
...
- Undo coalescing pre-elecetion wave already-voted vote choice, keeping `voted_*` variables with just post-election wave responses.
