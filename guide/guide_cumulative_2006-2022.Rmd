...
\noindent  A Stata dta version is provided as well. `cumulative_2006-2021.dta` can be read by Stata, or in R by the `haven` package 

```{r, eval = FALSE, echo = TRUE}
library(haven)
cc <- read_dta("cumulative_2006-2021.dta")
```
