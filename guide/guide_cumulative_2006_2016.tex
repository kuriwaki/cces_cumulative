...
\date{Guide last updated: 2018-02-11}
...
#   weight_vv <dbl>, weight_vv_post <dbl>, starttime <dttm>,
#   pid3 <int+lbl>, pid7 <int+lbl>, pid3_leaner <int+lbl>,
#   gender <int+lbl>, birthyr <int>, age <int>, race <int+lbl>,
...
\begin{verbatim}
 ...
 0.0000  0.3859  0.6986  1.0000  1.1686 20.0004 
\end{verbatim}
...
\begin{verbatim}
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
 0.0000  0.2892  0.5687  0.9633  1.1382 24.0297 
\end{verbatim}
...
\subsubsection{\texorpdfstring{\texttt{weight\_vv}: Survey weight for
validated
voters}{weight\_vv: Survey weight for validated voters}}\label{weight_vv-survey-weight-for-validated-voters}

{[}weight among validated voters to construct a representative sample of
the voters. Only available for some years.{]}

\begin{verbatim}
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max.    NA's 
   0.00    0.43    0.74    1.00    1.19   15.00  255421 
\end{verbatim}
...
\subsubsection{\texorpdfstring{\texttt{weight\_vv\_post}: Survey weight
for post-election wave validated
voters}{weight\_vv\_post: Survey weight for post-election wave validated voters}}\label{weight_vv_post-survey-weight-for-post-election-wave-validated-voters}

{[}weight among validated voters and post-election wave respondents to
construct a representative sample of the voters. Only available for some
years.{]}

\begin{verbatim}
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max.    NA's 
   0.00    0.32    0.64    0.89    1.06   15.00  265121 
\end{verbatim}
...
\begin{verbatim}
                    vv_party_gen      n
 No Record Of Party Registration  63049
                         Unknown  51053
                Democratic Party  26323
                Republican Party  21131
            No Party Affiliation   9187
               Declined To State   1559
                           Other   1275
               Independent Party   1169
              Liberatarian Party    366
                     Green Party    185
...
\begin{verbatim}
                    vv_party_prm      n
 No Record Of Party Registration 157651
                Republican Party   9827
                Democratic Party   7857
                            <NA> 199221
\end{verbatim}
...
\begin{verbatim}
                  voted_pres_16      n
      Donald Trump (Republican)  18826
     Hillary Clinton (Democrat)  22264
     Gary Johnson (Libertarian)   1858
             Jill Stein (Green)    924
                          Other   1144
 I Didn't Vote In This Election     89
                   I'm Not Sure    238
    Evan McMullin (Independent)    164
                           <NA> 329049
\end{verbatim}
...
\begin{verbatim}
                            voted_rep      n
             [Democrat / Candidate 1]  94644
           [Republican / Candidate 2]  94109
                [Other / Candidate 3]   2571
   $HouseCand4Name ($HouseCand4Party)     15
                                Other   2434
          I Did Not Vote In This Race  11576
...
\begin{verbatim}
                      voted_sen      n
       [Democrat / Candidate 1]  68796
     [Republican / Candidate 2]  63838
          [Other / Candidate 3]   2743
                          Other   1624
                       Not Sure   1845
 $SenCand4Name ($SenCand4Party)     11
    I Did Not Vote In This Race   4097
                           <NA> 231602
\end{verbatim}
...
\begin{verbatim}
                   voted_gov      n
    [Democrat / Candidate 1]  46270
  [Republican / Candidate 2]  44908
       [Other / Candidate 3]   2451
                       Other   1158
 I Did Not Vote In This Race   3928
                    Not Sure    911
                        <NA> 274930
\end{verbatim}
