...
ccc_meta <- tribble(
  ...
  "intent_rep_chosen",   "text",        "House preference (shown)",     "[Text chosen by respondent in intent_rep]",
  "intent_sen_chosen",   "text",        "Senate preference (shown)",    "[Text chosen by respondent in intent_sen]",
  "intent_gov_chosen",   "text",        "Governor preference (shown)",  "[Text chosen by respondent in intent_gov]",
  "voted_rep_chosen",    "text",        "House vote choice (shown)",    "[Text chosen by respondent in intent_rep]",
  "voted_sen_chosen",    "text",        "Senate vote choice (shown)",   "[Text chosen by respondent in voted_sen]",
  "voted_gov_chosen",    "text",        "Governor vote choice (shown)", "[Text chosen by respondent in voted_gov]",
  "intent_rep_fec",      "text",        "ID for House preference",      "[FEC ID for candidate chosen in intent_rep]",
  "intent_sen_fec",      "text",        "ID for Senate preference",     "[FEC ID for candidate chosen in intent_sen]",
  "intent_gov_fec",      "text",        "ID for Governor preference",   "[FEC ID for candidate chosen in intent_gov]",
  "voted_rep_fec",       "text",        "ID for House vote choice",     "[FEC ID for candidate chosen in voted_rep]",
  "voted_sen_fec",       "text",        "ID for Senate vote choice",    "[FEC ID for candidate chosen in voted_sen]",
  "voted_gov_fec",       "text",        "ID for Governor vote choice",  "[FEC ID for candidate chosen in voted_gov]",
  "rep_current",         "text",        "Current House Representative", "[Name and party used in CCES]",
  "sen1_current",        "text",        "Current Senator 1",            "[Name and party used in CCES]",
  "sen2_current",        "text",        "Current Senator 2",            "[Name and party used in CCES]",
  "gov_current",         "text",        "Current Governor",             "[Name and party used in CCES]",
  "rep_icpsr",           "text",        "ID for current House Representative", "[ICPSR / NOMINATE]",
