...
master$`2021` <- master$`2019` <- master$`2017`
...
ccc_meta <- tribble(
  ...
  "rvweight",            "numeric",     "Survey weights to validated registered voters",        "[weights to validated registered voter population]",
  "rvweight_post",       "numeric",     "Survey weights to validated registered voters, post-election wave", "[weights to validated registered voter population, post-election wave]",
  ...
  "intent_turnout_self", "cateogrical", "Self-reported turnout (pre-election wave)", "2020: Do you intend to vote in the 2020 general election on November 3rd?",
  "voted_turnout_self",  "cateogrical", "Self-reported turnout (post-election wave)", "2020: Which of the following statements best describes you?",
