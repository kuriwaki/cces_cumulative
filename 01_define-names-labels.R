...
ccc_meta <- tribble(
  ...
  "turnout_self_pre",    "cateogrical", "Self-reported turnout (pre-election wave)", "2020: Do you intend to vote in the 2020 general election on November 3rd?",
  "turnout_self_post",   "cateogrical", "Self-reported turnout (post-election wave)", "2020: Which of the following statements best describes you?",
