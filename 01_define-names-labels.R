...
ccc_meta <- tribble(
  ...
  "religpew_bornagain",  "categorical", "Evangelical Christian",         "Would you describe yourself as a born-again or evangelical Christian, or not?",
  "religpew_protestant", "categorical", "Branch of Protestantism",       "To which Protestant church or group do you belong?",
