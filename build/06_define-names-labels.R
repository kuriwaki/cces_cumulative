...
ccc_meta <- tribble(
  ...
  "cdid_up",             "categorical", "Congressional district number for upcoming Congress", "[Congressional District (Imputed from input zipcode)]",
  ...
  "rep_shown",           "text",        "Current House Representative (shown)", "",
  "sen1_shown",          "text",        "Current Senator 1 (shown)", "",
  "sen2_shown",          "text",        "Current Senator 2 (shown)", "",
  "gov_shown",           "text",        "Current Governor (shown)", "",
