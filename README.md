...
Election Study (CCES) cumulative file (2006 - 2024).

- [*Current Dataverse
  Version*](https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/II2DB6)
- [*Current
  Guide*](https://github.com/kuriwaki/cces_cumulative/blob/main/guide/guide_cumulative_2006-2024.pdf)
...
``` r
dat <- readRDS("cumulative_2006-2024.rds")
```
...
```
    ...
    ## # ℹ 701,945 more rows
    ## # ℹ 100 more variables: st_post <chr>, dist <int>, dist_up <int>, cd <chr>,
